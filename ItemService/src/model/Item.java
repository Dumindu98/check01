...
public class Item {
	...
	{
	output = "Error while updating the item."; System.err.println(e.getMessage());
	}
	...
	{   
	  ...
	  try   {    Connection con = connect(); 
	   ...
	   if (con == null)    {return "Error while connecting to the database for deleting."; } 
	   ...
	   output = "Deleted successfully";   }   catch (Exception e)   {    output = "Error while deleting the item.";    System.err.println(e.getMessage());   } 
